...
import 'page_height_model.dart';
export 'page_height_model.dart';

class PageHeightWidget extends StatefulWidget {
  const PageHeightWidget({Key? key}) : super(key: key);

  @override
  _PageHeightWidgetState createState() => _PageHeightWidgetState();
}

class _PageHeightWidgetState extends State<PageHeightWidget> {
  late PageHeightModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PageHeightModel());
