...
class PhotoCropUICopy extends StatefulWidget {
  const PhotoCropUICopy({
    Key? key,
    this.width,
    this.height,
  ...
  @override
  _PhotoCropUICopyState createState() => _PhotoCropUICopyState();
}

class _PhotoCropUICopyState extends State<PhotoCropUICopy> {
