...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, state) =>
          appStateNotifier.loggedIn ? CheckDataWidget() : GetStartedWidget(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
        ...
        FFRoute(
          name: 'VerifyPasswordPage',
          path: '/verifyPasswordPage',
          builder: (context, params) => VerifyPasswordPageWidget(
            currentPassword:
                params.getParam('currentPassword', ParamType.String),
            newPassword: params.getParam('newPassword', ParamType.String),
          ),
        ),
        FFRoute(
          name: 'AboutUsPage',
        ...
        FFRoute(
          name: 'LiftSelection',
          path: '/liftSelection',
          builder: (context, params) => LiftSelectionWidget(),
        ),
        FFRoute(
          name: 'NewExercisePage',
          path: '/newExercisePage',
          builder: (context, params) => NewExercisePageWidget(),
        ),
        FFRoute(
          name: 'Loader',
          path: '/loader',
        ...
        FFRoute(
          name: 'Bluetooth-1',
          path: '/bluetooth1',
          builder: (context, params) => Bluetooth1Widget(),
        ),
        FFRoute(
          name: 'WeightInput',
          path: '/weightInput',
        ...
        FFRoute(
          name: 'GCTLiveData',
          path: '/gCTLiveData',
          builder: (context, params) => GCTLiveDataWidget(),
        ),
        FFRoute(
          name: 'ViewDataJumpExport',
          path: '/viewDataJumpExport',
