...
import 'r_s_i_live_data_model.dart';
export 'r_s_i_live_data_model.dart';

class RSILiveDataWidget extends StatefulWidget {
  const RSILiveDataWidget({Key? key}) : super(key: key);

  @override
  _RSILiveDataWidgetState createState() => _RSILiveDataWidgetState();
}

class _RSILiveDataWidgetState extends State<RSILiveDataWidget> {
  late RSILiveDataModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RSILiveDataModel());
  }
