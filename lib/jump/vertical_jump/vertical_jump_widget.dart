...
import 'vertical_jump_model.dart';
export 'vertical_jump_model.dart';

class VerticalJumpWidget extends StatefulWidget {
  const VerticalJumpWidget({Key? key}) : super(key: key);

  @override
  _VerticalJumpWidgetState createState() => _VerticalJumpWidgetState();
}

class _VerticalJumpWidgetState extends State<VerticalJumpWidget> {
  late VerticalJumpModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => VerticalJumpModel());
  }
              ...
              child: Align(
                ...
                child: Column(
                  ...
                  children: [
                    Padding(
                      padding:
                          EdgeInsetsDirectional.fromSTEB(0.0, 30.0, 0.0, 18.0),
                      child: Container(
                  ...
                  children: [
                    ...
                    Expanded(
                      ...
                      child: Padding(
                        ...
                        child: FFButtonWidget(
                          onPressed: () async {
                            context.pushNamed('NewExercisePage');
                          },
                          text: 'NEW SET',
                          options: FFButtonOptions(
                            height: 55.0,
