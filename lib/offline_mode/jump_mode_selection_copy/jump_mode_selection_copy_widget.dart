...
import 'jump_mode_selection_copy_model.dart';
export 'jump_mode_selection_copy_model.dart';

class JumpModeSelectionCopyWidget extends StatefulWidget {
  const JumpModeSelectionCopyWidget({Key? key}) : super(key: key);

  @override
  _JumpModeSelectionCopyWidgetState createState() =>
      _JumpModeSelectionCopyWidgetState();
}

class _JumpModeSelectionCopyWidgetState
    extends State<JumpModeSelectionCopyWidget> {
  late JumpModeSelectionCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => JumpModeSelectionCopyModel());
  }
