                    ...
                    child: Row(
                      ...
                      children: [
                        InkWell(
                          ...
                          onTap: () async {
                            if (_model.pageViewCurrentIndex.toString() == '0') {
                                      ...
                                      children: [
                                        ...
                                        Padding(
                                          ...
                                          child: FFButtonWidget(
                                            onPressed: (_model.heightController
                                                                .text ==
                                                            null ||
                                                        _model.heightController
                                                                .text ==
                                                ...
                                                : () async {
                                                    setState(() {
                                                      FFAppState().height =
                                                          '${_model.heightController.text}${FFAppState().heightUnit}';
                                                    });
                                                    await _model
                                                        .pageViewController
                                                        ?.nextPage(
                                                    ...
                                                    onPressed: () async {
                                                      await buttonUserRecord
                                                        ...
                                                        userWeightUnit:
                                                            FFAppState()
                                                                .weightUnit,
                                                        userShowFatigue: false,
                                                        userEccentric: false,
                                                        userFilterJumps: false,
                                                      ));
                        ...
                        Align(
                          ...
                          child: smooth_page_indicator.SmoothPageIndicator(
                            ...
                            effect: smooth_page_indicator.SlideEffect(
                              ...
                              dotWidth: 55.0,
                              dotHeight: 2.0,
                              dotColor: FlutterFlowTheme.of(context).txtText5,
                              activeDotColor:
