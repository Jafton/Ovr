                                ...
                                children: [
                                  ...
                                  Builder(
                                    builder: (context) => FFButtonWidget(
                                      onPressed: (_model.usernameController.text == null ||
                                                  _model.usernameController
                                                          .text ==
                                                      '') ||
                                              ...
                                              (functions.validatorPassHasMaxLength(
                                                  ...
                                                  functions.validatorPassHasDigits(
                                                      _model.passwordFieldController.text) ||
                                                  functions.validatorPassHasMinLength(_model.passwordFieldController.text, 8) ||
                                                  functions.validatorPassHasUppercase(_model.passwordFieldController.text)) ||
                                              (functions.validatorPassHasMaxLength(_model.usernameController.text, 16) || functions.validatorPassHasMinLength(_model.usernameController.text, 4))
                                          ? null
                                          : () async {
                                              if (signUpUserRecord != null) {
                                                showAlignedDialog(
                                                  barrierColor:
                                                      Colors.transparent,
                                                  context: context,
                                                ...
                                                setState(() {
                                                  FFAppState().isCorrectEmail =
                                                      false;
                                                  FFAppState().isEmaillExist =
                                                      true;
                                                });
                                              } else {
                                                if (_model
