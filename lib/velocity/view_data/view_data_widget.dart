                                                            ...
                                                            StreamBuilder<
                                                              ...
                                                              builder: (context,
                                                                ...
                                                                List<DateOfExerciseRecord>
                                                                    columnDateOfExerciseRecordList =
                                                                    snapshot
                                                                        .data!;
                                                                return Column(
                                                                  mainAxisSize:
                                                                  ...
                                                                  children: List.generate(
                                                                      columnDateOfExerciseRecordList
                                                                          .length,
                                                                      (columnIndex) {
                                                                    final columnDateOfExerciseRecord =
                                                                        columnDateOfExerciseRecordList[
                                                                            columnIndex];
                                                                    return DateOfSetWidget(
                                                                      key: Key(
                                                                          'Keyxdc_${columnIndex}_of_${columnDateOfExerciseRecordList.length}'),
                                                                      dateRed:
                                                                          columnDateOfExerciseRecord
                                                                              .reference,
                                                                    );
                                                                  }),
                                                                );
